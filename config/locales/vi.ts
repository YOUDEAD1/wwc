...
export const vi: Record<string, string> = {
  ...
  'click_sounds.title': '🔊 *Âm thanh nút bấm*',
  'click_sounds.body':
    'Nhấn vào nút bên dưới để tắt hoặc bật âm thanh. Công tắc chính tắt toàn bộ âm thanh.',
  'click_sounds.master.on': '🔊 Chính: BẬT',
  'click_sounds.master.off': '🔇 Chính: TẮT',
  'click_sounds.cat.qty': 'Số lượng ±',
  'click_sounds.cat.other': 'Nút khác',
  'click_sounds.toast.muted': '🔇 Đã tắt: {label}',
  'click_sounds.toast.unmuted': '🔊 Đã bật: {label}',
  'click_sounds.toast.master_on': '🔊 Đã bật âm thanh nút bấm.',
  'click_sounds.toast.master_off': '🔇 Đã tắt âm thanh nút bấm.',
