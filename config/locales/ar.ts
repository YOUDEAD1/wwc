...
export const ar: Record<string, string> = {
  ...
  'support.ai.session_open':
    '{kiwi_ai} *مرحبًا! أنا كيوي، مساعد الدعم الآلي.*\n' +
    '*كيف يمكنني مساعدتك اليوم؟*\n\n' +
    'اسألني أي شيء عن متجرنا — المنتجات، الأسعار، طرق الدفع، الشحن، ' +
    'الإحالات، محفظتك — لدي كامل كتالوج المتجر. اضغط *إلغاء* عند ' +
    'الانتهاء وسأحفظ الدردشة كملف PDF يمكنك إرساله إلى بريدك.',
