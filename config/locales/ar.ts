...
export const ar: Record<string, string> = {
  ...
  'click_sounds.title': '🔊 *أصوات الأزرار*',
  'click_sounds.body':
    'اضغط على أي زر أدناه لكتم صوته أو إلغاء الكتم. المفتاح الرئيسي يوقف جميع الأصوات.',
  'click_sounds.master.on': '🔊 الرئيسي: مفعل',
  'click_sounds.master.off': '🔇 الرئيسي: معطل',
  'click_sounds.cat.qty': 'الكمية ±',
  'click_sounds.cat.other': 'أزرار أخرى',
  'click_sounds.toast.muted': '🔇 تم الكتم: {label}',
  'click_sounds.toast.unmuted': '🔊 تم إلغاء الكتم: {label}',
  'click_sounds.toast.master_on': '🔊 تم تفعيل أصوات الأزرار.',
  'click_sounds.toast.master_off': '🔇 تم إيقاف أصوات الأزرار.',
